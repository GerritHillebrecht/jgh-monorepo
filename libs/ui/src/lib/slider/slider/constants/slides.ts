...
export const slides: Slide[] = [
  // Gymbros
  {
    thumb: {
      ...
      src: 'assets/images/home/gymbro-image.webp',
    },
    image: {
    ...
    href: 'https://body-transformation.jgh-dev.de/',
    subtitle:
      "Get ready to unleash your full potential and achieve your fitness goals at our state-of-the-art fitness studio - with expert trainers, personalized workout plans, and a supportive community, we'll help you transform your body and life, so join now and start your journey towards a healthier, happier you!",
  },
  ...
  // Teams
  {
    ...
    href: 'https://social-media.jgh-dev.de/',
    subtitle:
  ...
  // Speed Reading
  {
    thumb: {
      ...
      src: 'assets/images/projects/speed-reading/sr-thumb.jpg',
      fit: 'contain',
      backgroundColor: 'rgb(250, 250, 249)',
    },
    image: {
      src: 'assets/images/projects/speed-reading/sr-image.jpg',
      overlayIntensity: 'dark',
    },
    title: 'Improve your reading skills',
    href: 'https://speed-reading.jgh-dev.de/',
  ...
  // Bionic Reading
  {
    ...
    href: 'https://body-transformation.jgh-dev.de/',
    subtitle:
      'Unlock the full potential of your reading skills with our revolutionary bionic-reading technology - read faster, retain more information, and improve your overall productivity with our expertly crafted training program, so sign up now and take your reading abilities to the next level!',
  },
